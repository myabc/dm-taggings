...
System-wide:
  ...
  gem install dm-is-taggable

Bundler:

  gem "dm-is-taggable", "~> 0.11"
...
For detailed docs see project's RDoc[http://rdoc.info/github/solnic/dm-is-taggable/master/frames]

== Authors and contributors

* Martin Gamsjaeger (snusnu[http://github.com/snusnu])
* Maxime Guilbot (maxime[http://github.com/maxime]) (original author)
